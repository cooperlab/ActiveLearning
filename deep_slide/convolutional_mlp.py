...
Some parameters of the CNN are changed based on the original code: 
   http://deeplearning.net/tutorial/code/convolutional_mlp.py

To run: 
   $THEANO_FLAGS=mode=FAST_RUN,device=gpu,floatX=float32,on_unused_input=ignore python convolutional_mlp.py
...
#learning_rate=0.095
def evaluate_lenet5(learning_rate=0.095, n_epochs=2000,
                    nkerns=[20, 50], batch_size=110):
